...
type nativeClusterAnalyzer struct {
	parent    context.Context
	snapshots ClusterSnapshotCollector
	analyze   func(context.Context, string, string, string, string) analysis.AnalysisMsg
}

func newNativeClusterAnalyzer(parent context.Context, snapshots ClusterSnapshotCollector) nativeClusterAnalyzer {
	return nativeClusterAnalyzer{
		parent:    parent,
		snapshots: snapshots,
		analyze:   analysis.AnalyzeClusterContext,
	}
}

func (a nativeClusterAnalyzer) Analyze(
	systemPrompt string,
	question string,
...
func unavailableClusterAnalysis(string, string, string, string) tea.Cmd {
	return func() tea.Msg {
		return analysis.AnalysisMsg{Err: ErrClusterAnalysisUnavailable}
	}
}
...
var _ clusterAnalyzer = nativeClusterAnalyzer{}
