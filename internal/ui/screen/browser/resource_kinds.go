...
const (
	resourceKindPod                   = string(screen.ResourceKindPod)
	resourceKindDeployment            = string(screen.ResourceKindDeployment)
	resourceKindService               = string(screen.ResourceKindService)
	resourceKindStatefulSet           = string(screen.ResourceKindStatefulSet)
	resourceKindDaemonSet             = string(screen.ResourceKindDaemonSet)
	resourceKindConfigMap             = string(screen.ResourceKindConfigMap)
	resourceKindNode                  = string(screen.ResourceKindNode)
	resourceKindJob                   = string(screen.ResourceKindJob)
	resourceKindIngress               = string(screen.ResourceKindIngress)
	resourceKindNetworkPolicy         = string(screen.ResourceKindNetworkPolicy)
	resourceKindPersistentVolumeClaim = "persistentvolumeclaim"
	resourceKindPVC                   = string(screen.ResourceKindPVC)
	resourceKindCronJob               = string(screen.ResourceKindCronJob)
	resourceKindHorizontalAutoscaler  = "horizontalpodautoscaler"
	resourceKindHPA                   = string(screen.ResourceKindHPA)
	resourceKindSecret                = string(screen.ResourceKindSecret)
	resourceKindReplicaSet            = string(screen.ResourceKindReplicaSet)
	...
	resourceKindRBAC                  = string(screen.ResourceKindRBAC)
)
