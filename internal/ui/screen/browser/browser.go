...
const (
	...
	narrowHorizontalSplitMinimum     = 90
	titleBarSidePadding              = 2
	pairedSides                      = 2
	percentageScale                  = 100
	browserTabStripMinimumWidth      = 10
	browserTabStripMinimumViable     = 6
	confirmationModalDesiredWidth    = 56
...
type BrowserModel struct {
	...
	ingressLive                 screen.LiveSupervisor[cluster.Ingress]
	networkPolicyLive           screen.LiveSupervisor[cluster.NetworkPolicy]
	persistentVolumeClaimLive   screen.LiveSupervisor[cluster.PersistentVolumeClaim]
	cronJobLive                 screen.LiveSupervisor[cluster.CronJob]
	horizontalPodAutoscalerLive screen.LiveSupervisor[cluster.HPA]
	secretLive                  screen.LiveSupervisor[cluster.Secret]
	replicaSetLive              screen.LiveSupervisor[cluster.ReplicaSet]
...
func NewBrowserModel(namespace string, commands clusterui.Commands, operations clusterui.Operations) BrowserModel {
...
func NewWithAnalysis(
	...
	return newBrowserWithAnalysis(namespace, commands, operations, analysisService)
}
...
func newBrowserWithAnalysis(
	...
	scaleInput := component.NewTextInput(component.TextInputOptions{
		Prompt:      "Replicas: ",
	...
	detailView := component.NewViewport(initialScreenWidth, initialViewportHeight)
