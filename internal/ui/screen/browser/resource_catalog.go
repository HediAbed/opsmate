...
type resourceBinding struct {
	...
	Fetch        func(clusterui.Commands, string) tea.Cmd
...
var resourceCatalog = map[string]resourceBinding{
	resourceTypePods: {
		...
		Fetch: clusterui.Commands.FetchPods,
	...
	resourceTypeDeployments: {
		...
		Fetch: clusterui.Commands.FetchDeployments,
	...
	resourceTypeServices: {
		...
		Fetch: clusterui.Commands.FetchServices,
	...
	resourceTypeStatefulSets: {
		...
		Fetch: clusterui.Commands.FetchStatefulSets,
	...
	resourceTypeDaemonSets: {
		...
		Fetch: clusterui.Commands.FetchDaemonSets,
	...
	resourceTypeConfigMaps: {
		...
		Fetch: clusterui.Commands.FetchConfigMaps,
	...
	resourceTypeNodes: {
		...
		Fetch:        func(commands clusterui.Commands, _ string) tea.Cmd { return commands.FetchNodes() },
	...
	resourceTypeJobs: {
		...
		Fetch: clusterui.Commands.FetchJobs,
	...
	resourceTypeIngresses: {
		...
		Fetch: clusterui.Commands.FetchIngresses,
	...
	resourceTypeNetworkPolicies: {
		...
		Fetch: clusterui.Commands.FetchNetworkPolicies,
	...
	resourceTypePVCs: {
		...
		Fetch: clusterui.Commands.FetchPVCs,
	...
	resourceTypeCronJobs: {
		...
		Fetch: clusterui.Commands.FetchCronJobs,
	...
	resourceTypeHPAs: {
		...
		Fetch: clusterui.Commands.FetchHPAs,
	...
	resourceTypeSecrets: {
		...
		Fetch: clusterui.Commands.FetchSecrets,
	...
	resourceTypeReplicaSets: {
		...
		Fetch: clusterui.Commands.FetchReplicaSets,
	...
	resourceTypeRBAC: {
		...
		Fetch:        clusterui.Commands.FetchRBAC,
		Clear:        func(model *BrowserModel) { model.rbac = nil },
		Count:        func(model *BrowserModel) int { return len(model.rbac) },
	},
}

func SupportsResourceType(resourceType string) bool {
	_, supported := resourceCatalog[strings.ToLower(strings.TrimSpace(resourceType))]
	return supported
}

func ResourceTypeForKind(kind string) string {
	normalized := strings.ToLower(strings.TrimSpace(kind))
	if SupportsResourceType(normalized) {
		return normalized
	}
	for resourceType, binding := range resourceCatalog {
		if binding.Singular == normalized {
			return resourceType
		}
	}
	return ""
